...
public int overallScore()
{
   int s;
   if (score1 < score2)
      s = score1; //We need to subtract smallest number score1 not largest number score2, s needs to be the smaller number score1.
   else
      s = score2; //If score1 is larger we need to subtract score2, s needs to be the smaller number score2.
   if (s > score3)
      s = score3;
